...
@section('title', 'AdminPanel - Edit Post')
...
@section('content')
    <div class="content">
        <form role="form" method="post" action="{{route('post.update', $post->slug)}}">
            {{method_field('PUT')}}
                    ...
                    <!-- /.box-header -->
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" disabled id="slug" name= "slug" value="{{$post->slug}}" placeholder="Post Slug">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="featured_image" class="form-control" value="{{$post->featured_image}}" placeholder="http://www.your_image_url">
                            </div>
                            <div class="form-group">
                                <label for="img_alt_text">Featured Image Alt-Text</label>
                                <input type="text" name="img_alt_text" class="form-control" value="{{$post->img_alt_text}}" placeholder="Enter featured image alt text">
                            </div>
                        </div>
